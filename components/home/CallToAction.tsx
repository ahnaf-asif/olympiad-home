      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-2xl bg-slate-900 p-6 sm:p-8 md:p-12 border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
          ...
          <div className="flex flex-col gap-2.5 max-w-2xl text-left">
            <span className="text-[11px] md:text-xs font-bold uppercase tracking-wider text-indigo-400">
              Join Bangladesh&apos;s Academic Revolution
            </span>
            ...
            <p className="text-sm md:text-base text-slate-300 leading-relaxed font-normal">
              Whether you are an aspiring student, a medalist looking to mentor, or an institution seeking collaboration—welcome to The Olympiad Playground.
            </p>
          </div>
